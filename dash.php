...
while($row = mysqli_fetch_array($result)) {
	...
	$eid = $row['eid'];
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update.php?q=rmquiz&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b>   
  <b><a href="edit.php?eid='.$eid.'" class="pull-right btn sub1 btn-warning" style="margin:0px;"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>&nbsp;<span class="title1"><b>EDIT</b></span></a></b>
  </td></tr>';
}
$c=0;
echo '</table></div></div>';
